    ...
    public static void main(String[] args) {
        ...
        try {
            FileReader f = new FileReader(
                    "F://niit//week2-day2//challenge-31-boilerplate-ecommerce//data//purchase_details.csv");
            ...
            while ((line = b.readLine()) != null) {
                ...
                if (Date != null && Customer_id != null && Product_category != null && Payment_method != null
                        && Value != null && Time_on_site != null && Clicks_in_site != null) {
                    e[i] = new ecommerce(Date, Customer_id, Product_category, Payment_method, Value, Time_on_site,
                            Clicks_in_site);
                    i++;
                }
            }
        ...
        for (i = l; i < 24999; i++) {
            ...
            System.out.println("On " + e[i].getDate() + " Highest sold Product Categorie is " + arr[q]
                    + " and Lowest sold Product Categorie is " + arr[w]);
            Arrays.fill(unique, 0);
